            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <a href="{{ route('createShift') }}"><ion-icon name="add" data-toggle="tooltip" data-placement="bottom" title="Add a Shift"></ion-icon></a>
        ...
        var columnDefs = [
            ...
            },
            {
                headerName: "Actions", field: "id", sortable: false, resizable: true, cellRenderer: function (params) {
                    return '<a href="/shifts/' + params.data.id + '/update" class="text-success"><ion-icon name="create"></ion-icon></a>'
                        + '<a href="/shifts/' + params.data.id + '/delete" class="text-danger"><ion-icon name="trash"></ion-icon></a>'
                }
            }
        ];
