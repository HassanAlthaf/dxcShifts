            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        Updating Role: '{{ $role->code }}'
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('submitUpdateRole', ['id' => $role->id]) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ $role->code }}" readonly disabled>
