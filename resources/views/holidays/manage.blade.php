            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <a href="{{ route('createHoliday') }}"><ion-icon name="add" data-toggle="tooltip" data-placement="bottom" title="Add a Holiday"></ion-icon></a>
...
@section('scripts-body')
    <script type="text/javascript">
        var columnDefs = [
            {
                headerName: "Date", field: "date", sortable: true, resizable: true
            },
            {
                headerName: "Description", field: "description", sortable: true, resizable: true
            },
            {
                headerName: "Holiday Type", field: "holidayType", sortable: true, resizable: true
            },
            {
                headerName: "Actions", field: "id", sortable: false, resizable: true, cellRenderer: function (params) {
                    return '<a href="/holidays/' + params.data.id + '/update" class="text-success"><ion-icon name="create"></ion-icon></a>'
                        + '<a href="/holidays/' + params.data.id + '/delete" class="text-danger"><ion-icon name="trash"></ion-icon></a>'
                }
            }
        ];

        var rowData = {!! $holidays !!}
